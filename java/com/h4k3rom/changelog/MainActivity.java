...
public class MainActivity extends AppCompatActivity {
    ...
    public void open4(View view) {
        ...
        Intent i=getPackageManager().getLaunchIntentForPackage("com.google.android.apps.wallpaper");
        startActivity(i);
    }
    public void open5(View view) {
        Intent browserIntent= new Intent (Intent.ACTION_VIEW, Uri.parse("https://raw.githubusercontent.com/H4K3ROM/H4K3ROM/master/h4k3rom2.gif"));
        startActivity(browserIntent);
    }
}
